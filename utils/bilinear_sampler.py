...
def bilinear_sampler_1d_h(input_images, x_offset, wrap_mode='border', name='bilinear_sampler', **kwargs):
    ...
    def _transform(input_images, x_offset):
        with tf.compat.v1.variable_scope('transform'):
            ...
            if output.get_shape().as_list()[1] == None:
    ...
    with tf.compat.v1.variable_scope(name):
        ...
        if type(input_images) is not np.ndarray:
            ...
            _height_        = input_images.get_shape().as_list()[1]
            _width_         = input_images.get_shape().as_list()[2]
            ...
            _height_        = input_images.shape[1]
            _width_         = input_images.shape[2]
